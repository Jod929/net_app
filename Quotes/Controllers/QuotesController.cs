...
namespace Quotes.Controllers
{
    public class QuotesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString)
        {
            ...
            IQueryable<string> genreQuery = from m in _context.Quote
                                            orderby m.Genre
                                            select m.Genre;
            var movies = from m in _context.Quote
                        select m;
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price")] Quote quote)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price")] Quote quote)
        {
            if (id != quote.Id)
            {
                return NotFound();
